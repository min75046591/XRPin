...
namespace NRKernal.Experimental
{
    ...
    */
    internal partial class NativePointCloud
    {
        ...
        {
            int confidence = -1;
            NativeResult result = NativeApi.NRPointCloudConfidence(m_DatabaseHandle, ref confidence);
            NativeErrorListener.Check(result, this, "GetConfidence");
            return confidence;
        }
        ...
        public PointCloudPoint AquireItem(UInt64 pointlistHandle, int index)
        {
            ...
            NativeResult result = NativeApi.NRPointCloudListAquireItem(m_DatabaseHandle, pointlistHandle, index, ref point);
            NativeErrorListener.Check(result, this, "AquireItem");
