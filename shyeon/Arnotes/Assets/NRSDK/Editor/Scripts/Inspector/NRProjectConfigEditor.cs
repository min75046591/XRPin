...
public class NRProjectConfigEditor : UnityEditor.Editor
{
    ...
    public static void DrawUniqueProjectConfig(NRProjectConfig projectConfig)
    {
        ...
        EditorGUILayout.BeginVertical(EditorStyles.helpBox);
        NREditorUtility.ObjectField<TextAsset>(projectConfig, projectConfig.licenseAsset, "license", false, asset => projectConfig.licenseAsset = (TextAsset)asset, ref modify);
        EditorGUILayout.EndVertical();
