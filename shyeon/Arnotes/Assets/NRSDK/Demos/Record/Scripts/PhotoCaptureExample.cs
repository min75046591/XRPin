    ...
    public class PhotoCaptureExample : MonoBehaviour
    {
        ...
        public string ImageSavePath
        {
            get {
                ...
                string fileName = string.Format("Nreal_Capture_{0}.png", timeStamp);
        ...
        void OnCapturedPhotoToMemory(NRPhotoCapture.PhotoCaptureResult result, PhotoCaptureFrame photoCaptureFrame)
        {
            ...
            //Saving the capture photo
            var image = targetTexture.EncodeToPNG();
            File.WriteAllBytes(ImageSavePath, image);
